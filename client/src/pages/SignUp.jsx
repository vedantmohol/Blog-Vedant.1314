      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm mt-5">
            Signup with your email and password to deep dive
            into new upcoming blogs!
          </p>
        </div>
        {/* right */}
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="username" className="block mb-1 text-sm font-medium text-gray-700 dark:text-white">
                Your Username
              </label>
              <input
                type="text"
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-800 dark:text-white"
              />
            </div>
            <div>
